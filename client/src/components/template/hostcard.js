...
<Col m={6} s={12} offset = "m3"  >
    <Card
      ...
      header={<CardTitle image="sampleimg.jpg"> <span className = "black"><span className="">{this.state.fname.toLocaleTimeString()} <br/> <span className="offset-s1  rating"> {this.state.fstar} <Icon className=" red-text">star_border
